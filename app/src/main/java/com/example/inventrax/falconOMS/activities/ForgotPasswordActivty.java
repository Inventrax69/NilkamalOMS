...
public class ForgotPasswordActivty extends AppCompatActivity {
    ...
    public void forgotPassword() {
        ...
        loginDTO.setUserIP("192.167.1.174");
        ...
        try {
            ...
            call.enqueue(new Callback<OMSCoreMessage>() {
                                ...
                                if (_lstLogindetails != null) {
                                    for (Map.Entry<String, String> entry : _lstLogindetails.entrySet()) {
                                        ...
                                        if (entry.getKey().equals("Result")) {
                                            ...
                                            common.showUserDefinedAlertType(entry.getValue().toString(), ForgotPasswordActivty.this, getApplicationContext(), "Success");
                                            startActivity(new Intent(ForgotPasswordActivty.this,LoginActivity.class));
                                            finish();
                                            return;
                ...
                public void onFailure(Call<OMSCoreMessage> call, Throwable throwable) {
                    Toast.makeText(ForgotPasswordActivty.this, throwable.toString(), Toast.LENGTH_LONG).show();
                    ProgressDialogUtils.closeProgressDialog();
                }
            });
        } catch (Exception ex) {
