...
@Database(entities = {CustomerTable.class, ItemTable.class, VariantTable.class, CartDetails.class,
        UserDivisionCustTable.class, CartHeader.class}, version = 1)
...
public abstract  class AppDatabase extends RoomDatabase {
    ...
    public abstract CartHeaderDetailsDao cartHeaderDetailsDao();
}
