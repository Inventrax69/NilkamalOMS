...
{
    // hexa decimal secret key for encryption
    static String hexKey = "69 6e 76 65 6e 74 72 61 78 73 75 70 65 72 70 61 73 73 77 6f 72 64 65 6e 63 72 79 70 74 69 6f 6e";
    ...
    public static String decryptData(String hexStr) throws Exception
    {
        checkKey(hexKey);
