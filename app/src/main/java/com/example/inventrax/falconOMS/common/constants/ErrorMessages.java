...
public class ErrorMessages {
    ...
    public String EMC_0015 = "Please enter correct url";

    public String EMC_0016 = "Error while initializing controls";

    public String EMC_0017 = "Please configure URL.";

    public String EMC_0018 = "No items found";

    public String EMC_0019 = "No cart access for this user role";

    public String EMC_0020 = "No orders list";

    public String EMC_0021 = "Saved successfully";

    public String EMC_0022 = "Service url not be empty";

    public String EMC_0023 = "Please select the customer";
